...
* реализован универсальный подход к приемникам и передатчикам данных, теперь любой источник данных, будь то удаленный сервис инженерных расчетов или frontend может быть как приемником, так и пердатчиком информации 
