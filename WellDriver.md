...
* Планируется добавление аналитических задач, в том числе с использованием Искусственного Интеллекта (ML, DL, нейронные сети, ChatGPT etc).
...
* Система автоматически получает данные с 10 источников информации на буровой площадке, у каждого источника 100 параметров.
...
* Система передает на центральный сервис параметры бурения и получает из него расчетные значения для автоматического бурения. 
...
* Надежность - Не должно быть потери информации. Хранение информации в течение 1 года.
...
* Масштабируемость - x10, должна быть предусмотрена возможность значительного увеличения источников данных и параметров.
* Модифицируемость - возможность добавления новых функций и безшовного изменения старых.
